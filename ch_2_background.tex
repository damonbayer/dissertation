...
We assume that the new data \( \bX^* \) are realized samples from some underlying probability distribution \( G \), which is only known to nature.
...
% Striclty proper scoring rules decompose based on winkler 1996
