...
This is a clear departure from the models we fit in our simulation study, where the second peak's size compared to the first peak, so we chose to adjust the models used in the simulation study to also include modeling the case detection rate with a Gaussian Markov random field.
