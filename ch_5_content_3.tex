...
In some models, we parameterize \( R_0(t) \), \( 1 / \kappa(t) \), or \( \rho(t) \) as piecewise constant functions, where each vector defining the constants a prior follows a Gaussian Markov random field (GMRF).
