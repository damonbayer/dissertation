...
In our simulation study and application in Section~\ref{ch_5:sec:results}, we observe the non-genetic data at a weekly resolution, while the genetic data is reported at a daily resolution, so the two groups of time series
